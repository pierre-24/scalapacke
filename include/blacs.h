...
/* Declarations
 */
extern void cgamn2d_(const lapack_int* ConTxt, const char* scope, const char* top, const lapack_int* m, const lapack_int* n, lapack_complex_float* A, const lapack_int* lda, lapack_int* rA, lapack_int* cA, const lapack_int* ldia, const lapack_int* rdest, const lapack_int* cdest);
...
extern void zgamn2d_(const lapack_int* ConTxt, const char* scope, const char* top, const lapack_int* m, const lapack_int* n, lapack_complex_double* A, const lapack_int* lda, lapack_int* rA, lapack_int* cA, const lapack_int* ldia, const lapack_int* rdest, const lapack_int* cdest);
extern void cgamx2d_(const lapack_int* ConTxt, const char* scope, const char* top, const lapack_int* m, const lapack_int* n, lapack_complex_float* A, const lapack_int* lda, lapack_int* rA, lapack_int* cA, const lapack_int* ldia, const lapack_int* rdest, const lapack_int* cdest);
...
extern void zgamx2d_(const lapack_int* ConTxt, const char* scope, const char* top, const lapack_int* m, const lapack_int* n, lapack_complex_double* A, const lapack_int* lda, lapack_int* rA, lapack_int* cA, const lapack_int* ldia, const lapack_int* rdest, const lapack_int* cdest);
extern void cgebr2d_(const lapack_int* ConTxt, const char* scope, const char* top, const lapack_int* m, const lapack_int* n, lapack_complex_float* A, const lapack_int* lda, const lapack_int* rsrc, const lapack_int* csrc);
...
extern void zgebr2d_(const lapack_int* ConTxt, const char* scope, const char* top, const lapack_int* m, const lapack_int* n, lapack_complex_double* A, const lapack_int* lda, const lapack_int* rsrc, const lapack_int* csrc);
extern void cgebs2d_(const lapack_int* ConTxt, const char* scope, const char* top, const lapack_int* m, const lapack_int* n, const lapack_complex_float* A, const lapack_int* lda);
...
extern void zgebs2d_(const lapack_int* ConTxt, const char* scope, const char* top, const lapack_int* m, const lapack_int* n, const lapack_complex_double* A, const lapack_int* lda);
extern void cgerv2d_(const lapack_int* ConTxt, const lapack_int* m, const lapack_int* n, lapack_complex_float* A, const lapack_int* lda, const lapack_int* rsrc, const lapack_int* csrc);
...
extern void zgerv2d_(const lapack_int* ConTxt, const lapack_int* m, const lapack_int* n, lapack_complex_double* A, const lapack_int* lda, const lapack_int* rsrc, const lapack_int* csrc);
extern void cgesd2d_(const lapack_int* ConTxt, const lapack_int* m, const lapack_int* n, const lapack_complex_float* A, const lapack_int* lda, const lapack_int* rdest, const lapack_int* cdest);
...
extern void zgesd2d_(const lapack_int* ConTxt, const lapack_int* m, const lapack_int* n, const lapack_complex_double* A, const lapack_int* lda, const lapack_int* rdest, const lapack_int* cdest);
extern void cgsum2d_(const lapack_int* ConTxt, const char* scope, const char* top, const lapack_int* m, const lapack_int* n, lapack_complex_float* A, const lapack_int* lda, const lapack_int* rdest, const lapack_int* cdest);
...
extern void zgsum2d_(const lapack_int* ConTxt, const char* scope, const char* top, const lapack_int* m, const lapack_int* n, lapack_complex_double* A, const lapack_int* lda, const lapack_int* rdest, const lapack_int* cdest);
extern void ctrbr2d_(const lapack_int* ConTxt, const char* scope, const char* top, const char* uplo, const char* diag, const lapack_int* m, const lapack_int* n, lapack_complex_float* A, const lapack_int* lda, const lapack_int* rsrc, const lapack_int* csrc);
...
extern void ztrbr2d_(const lapack_int* ConTxt, const char* scope, const char* top, const char* uplo, const char* diag, const lapack_int* m, const lapack_int* n, lapack_complex_double* A, const lapack_int* lda, const lapack_int* rsrc, const lapack_int* csrc);
extern void ctrbs2d_(const lapack_int* ConTxt, const char* scope, const char* top, const char* uplo, const char* diag, const lapack_int* m, const lapack_int* n, const lapack_complex_float* A, const lapack_int* lda);
...
extern void ztrbs2d_(const lapack_int* ConTxt, const char* scope, const char* top, const char* uplo, const char* diag, const lapack_int* m, const lapack_int* n, const lapack_complex_double* A, const lapack_int* lda);
extern void ctrrv2d_(const lapack_int* ConTxt, const char* uplo, const char* diag, const lapack_int* m, const lapack_int* n, lapack_complex_float* A, const lapack_int* lda, const lapack_int* rsrc, const lapack_int* csrc);
...
extern void ztrrv2d_(const lapack_int* ConTxt, const char* uplo, const char* diag, const lapack_int* m, const lapack_int* n, lapack_complex_double* A, const lapack_int* lda, const lapack_int* rsrc, const lapack_int* csrc);
extern void ctrsd2d_(const lapack_int* ConTxt, const char* uplo, const char* diag, const lapack_int* m, const lapack_int* n, const lapack_complex_float* A, const lapack_int* lda, const lapack_int* rdest, const lapack_int* cdest);
...
extern void ztrsd2d_(const lapack_int* ConTxt, const char* uplo, const char* diag, const lapack_int* m, const lapack_int* n, const lapack_complex_double* A, const lapack_int* lda, const lapack_int* rdest, const lapack_int* cdest);
