...
void SCALAPACKE_pcagemv(const char* TRANS, const lapack_int M, const lapack_int N, const float ALPHA, const lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_float* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, const float BETA, float* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY) {
...
void SCALAPACKE_pzagemv(const char* TRANS, const lapack_int M, const lapack_int N, const double ALPHA, const lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_double* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, const double BETA, double* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY) {
    pzagemv_(TRANS, &M, &N, &ALPHA, A, &IA, &JA, DESCA, X, &IX, &JX, DESCX, &INCX, &BETA, Y, &IY, &JY, DESCY, &INCY);
}

void SCALAPACKE_pcahemv(const char* UPLO, const lapack_int N, const float ALPHA, const lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_float* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, const float BETA, float* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY) {
    pcahemv_(UPLO, &N, &ALPHA, A, &IA, &JA, DESCA, X, &IX, &JX, DESCX, &INCX, &BETA, Y, &IY, &JY, DESCY, &INCY);
}

void SCALAPACKE_pzahemv(const char* UPLO, const lapack_int N, const double ALPHA, const lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_double* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, const double BETA, double* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY) {
    pzahemv_(UPLO, &N, &ALPHA, A, &IA, &JA, DESCA, X, &IX, &JX, DESCX, &INCX, &BETA, Y, &IY, &JY, DESCY, &INCY);
}

void SCALAPACKE_pcamax(const lapack_int N, lapack_complex_float* AMAX, lapack_int* INDX, const lapack_complex_float* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX) {
...
void SCALAPACKE_pzamax(const lapack_int N, lapack_complex_double* AMAX, lapack_int* INDX, const lapack_complex_double* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX) {
...
void SCALAPACKE_pcatrmv(const char* UPLO, const char* TRANS, const char* DIAG, const lapack_int N, const float ALPHA, const lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_float* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, const float BETA, float* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY) {
...
void SCALAPACKE_pzatrmv(const char* UPLO, const char* TRANS, const char* DIAG, const lapack_int N, const double ALPHA, const lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_double* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, const double BETA, double* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY) {
    pzatrmv_(UPLO, TRANS, DIAG, &N, &ALPHA, A, &IA, &JA, DESCA, X, &IX, &JX, DESCX, &INCX, &BETA, Y, &IY, &JY, DESCY, &INCY);
}

void SCALAPACKE_pcaxpy(const lapack_int N, const lapack_complex_float ALPHA, const lapack_complex_float* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, lapack_complex_float* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY) {
...
void SCALAPACKE_pzaxpy(const lapack_int N, const lapack_complex_double ALPHA, const lapack_complex_double* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, lapack_complex_double* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY) {
    pzaxpy_(&N, &ALPHA, X, &IX, &JX, DESCX, &INCX, Y, &IY, &JY, DESCY, &INCY);
}

void SCALAPACKE_pscasum(const lapack_int N, float* ASUM, const lapack_complex_float* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX) {
    pscasum_(&N, ASUM, X, &IX, &JX, DESCX, &INCX);
}

void SCALAPACKE_pscnrm2(const lapack_int N, float* NORM2, const lapack_complex_float* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX) {
    pscnrm2_(&N, NORM2, X, &IX, &JX, DESCX, &INCX);
}

void SCALAPACKE_pccopy(const lapack_int N, const lapack_complex_float* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, lapack_complex_float* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY) {
...
void SCALAPACKE_pzcopy(const lapack_int N, const lapack_complex_double* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, lapack_complex_double* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY) {
...
void SCALAPACKE_pcdotc(const lapack_int N, lapack_complex_float* DOT, const lapack_complex_float* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, const lapack_complex_float* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY) {
    pcdotc_(&N, DOT, X, &IX, &JX, DESCX, &INCX, Y, &IY, &JY, DESCY, &INCY);
}

void SCALAPACKE_pzdotc(const lapack_int N, lapack_complex_double* DOT, const lapack_complex_double* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, const lapack_complex_double* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY) {
    pzdotc_(&N, DOT, X, &IX, &JX, DESCX, &INCX, Y, &IY, &JY, DESCY, &INCY);
}

void SCALAPACKE_pcdotu(const lapack_int N, lapack_complex_float* DOT, const lapack_complex_float* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, const lapack_complex_float* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY) {
    pcdotu_(&N, DOT, X, &IX, &JX, DESCX, &INCX, Y, &IY, &JY, DESCY, &INCY);
}

void SCALAPACKE_pzdotu(const lapack_int N, lapack_complex_double* DOT, const lapack_complex_double* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, const lapack_complex_double* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY) {
    pzdotu_(&N, DOT, X, &IX, &JX, DESCX, &INCX, Y, &IY, &JY, DESCY, &INCY);
}

void SCALAPACKE_pzdscal(const lapack_int N, const double ALPHA, lapack_complex_double* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX) {
    pzdscal_(&N, &ALPHA, X, &IX, &JX, DESCX, &INCX);
}

void SCALAPACKE_pcgeadd(const char* TRANS, const lapack_int M, const lapack_int N, const lapack_complex_float ALPHA, const lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_float BETA, lapack_complex_float* C, const lapack_int IC, const lapack_int JC, const lapack_int* DESCC) {
...
void SCALAPACKE_pzgemm(const char* TRANSA, const char* TRANSB, const lapack_int M, const lapack_int N, const lapack_int K, const lapack_complex_double ALPHA, const lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_double* B, const lapack_int IB, const lapack_int JB, const lapack_int* DESCB, const lapack_complex_double BETA, lapack_complex_double* C, const lapack_int IC, const lapack_int JC, const lapack_int* DESCC) {
    pzgemm_(TRANSA, TRANSB, &M, &N, &K, &ALPHA, A, &IA, &JA, DESCA, B, &IB, &JB, DESCB, &BETA, C, &IC, &JC, DESCC);
}

void SCALAPACKE_pcgemv(const char* TRANS, const lapack_int M, const lapack_int N, const lapack_complex_float ALPHA, const lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_float* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, const lapack_complex_float BETA, lapack_complex_float* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY) {
...
void SCALAPACKE_pzgemv(const char* TRANS, const lapack_int M, const lapack_int N, const lapack_complex_double ALPHA, const lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_double* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, const lapack_complex_double BETA, lapack_complex_double* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY) {
...
void SCALAPACKE_pcgerc(const lapack_int M, const lapack_int N, const lapack_complex_float ALPHA, const lapack_complex_float* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, const lapack_complex_float* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY, lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA) {
    pcgerc_(&M, &N, &ALPHA, X, &IX, &JX, DESCX, &INCX, Y, &IY, &JY, DESCY, &INCY, A, &IA, &JA, DESCA);
}

void SCALAPACKE_pzgerc(const lapack_int M, const lapack_int N, const lapack_complex_double ALPHA, const lapack_complex_double* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, const lapack_complex_double* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY, lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA) {
    pzgerc_(&M, &N, &ALPHA, X, &IX, &JX, DESCX, &INCX, Y, &IY, &JY, DESCY, &INCY, A, &IA, &JA, DESCA);
}

void SCALAPACKE_pcgeru(const lapack_int M, const lapack_int N, const lapack_complex_float ALPHA, const lapack_complex_float* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, const lapack_complex_float* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY, lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA) {
    pcgeru_(&M, &N, &ALPHA, X, &IX, &JX, DESCX, &INCX, Y, &IY, &JY, DESCY, &INCY, A, &IA, &JA, DESCA);
}

void SCALAPACKE_pzgeru(const lapack_int M, const lapack_int N, const lapack_complex_double ALPHA, const lapack_complex_double* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, const lapack_complex_double* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY, lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA) {
    pzgeru_(&M, &N, &ALPHA, X, &IX, &JX, DESCX, &INCX, Y, &IY, &JY, DESCY, &INCY, A, &IA, &JA, DESCA);
}

void SCALAPACKE_pchemm(const char* SIDE, const char* UPLO, const lapack_int M, const lapack_int N, const lapack_complex_float ALPHA, const lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_float* B, const lapack_int IB, const lapack_int JB, const lapack_int* DESCB, const lapack_complex_float BETA, lapack_complex_float* C, const lapack_int IC, const lapack_int JC, const lapack_int* DESCC) {
    pchemm_(SIDE, UPLO, &M, &N, &ALPHA, A, &IA, &JA, DESCA, B, &IB, &JB, DESCB, &BETA, C, &IC, &JC, DESCC);
}

void SCALAPACKE_pzhemm(const char* SIDE, const char* UPLO, const lapack_int M, const lapack_int N, const lapack_complex_double ALPHA, const lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_double* B, const lapack_int IB, const lapack_int JB, const lapack_int* DESCB, const lapack_complex_double BETA, lapack_complex_double* C, const lapack_int IC, const lapack_int JC, const lapack_int* DESCC) {
    pzhemm_(SIDE, UPLO, &M, &N, &ALPHA, A, &IA, &JA, DESCA, B, &IB, &JB, DESCB, &BETA, C, &IC, &JC, DESCC);
}

void SCALAPACKE_pchemv(const char* UPLO, const lapack_int N, const lapack_complex_float ALPHA, const lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_float* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, const lapack_complex_float BETA, lapack_complex_float* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY) {
    pchemv_(UPLO, &N, &ALPHA, A, &IA, &JA, DESCA, X, &IX, &JX, DESCX, &INCX, &BETA, Y, &IY, &JY, DESCY, &INCY);
}

void SCALAPACKE_pzhemv(const char* UPLO, const lapack_int N, const lapack_complex_double ALPHA, const lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_double* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, const lapack_complex_double BETA, lapack_complex_double* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY) {
    pzhemv_(UPLO, &N, &ALPHA, A, &IA, &JA, DESCA, X, &IX, &JX, DESCX, &INCX, &BETA, Y, &IY, &JY, DESCY, &INCY);
}

void SCALAPACKE_pcher2(const char* UPLO, const lapack_int N, const lapack_complex_float ALPHA, const lapack_complex_float* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, const lapack_complex_float* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY, lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA) {
    pcher2_(UPLO, &N, &ALPHA, X, &IX, &JX, DESCX, &INCX, Y, &IY, &JY, DESCY, &INCY, A, &IA, &JA, DESCA);
}

void SCALAPACKE_pzher2(const char* UPLO, const lapack_int N, const lapack_complex_double ALPHA, const lapack_complex_double* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, const lapack_complex_double* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY, lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA) {
    pzher2_(UPLO, &N, &ALPHA, X, &IX, &JX, DESCX, &INCX, Y, &IY, &JY, DESCY, &INCY, A, &IA, &JA, DESCA);
}

void SCALAPACKE_pcher2k(const char* UPLO, const char* TRANS, const lapack_int N, const lapack_int K, const lapack_complex_float ALPHA, const lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_float* B, const lapack_int IB, const lapack_int JB, const lapack_int* DESCB, const float BETA, lapack_complex_float* C, const lapack_int IC, const lapack_int JC, const lapack_int* DESCC) {
    pcher2k_(UPLO, TRANS, &N, &K, &ALPHA, A, &IA, &JA, DESCA, B, &IB, &JB, DESCB, &BETA, C, &IC, &JC, DESCC);
}

void SCALAPACKE_pzher2k(const char* UPLO, const char* TRANS, const lapack_int N, const lapack_int K, const lapack_complex_double ALPHA, const lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_double* B, const lapack_int IB, const lapack_int JB, const lapack_int* DESCB, const double BETA, lapack_complex_double* C, const lapack_int IC, const lapack_int JC, const lapack_int* DESCC) {
    pzher2k_(UPLO, TRANS, &N, &K, &ALPHA, A, &IA, &JA, DESCA, B, &IB, &JB, DESCB, &BETA, C, &IC, &JC, DESCC);
}

void SCALAPACKE_pcher(const char* UPLO, const lapack_int N, const float ALPHA, const lapack_complex_float* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA) {
    pcher_(UPLO, &N, &ALPHA, X, &IX, &JX, DESCX, &INCX, A, &IA, &JA, DESCA);
}

void SCALAPACKE_pzher(const char* UPLO, const lapack_int N, const double ALPHA, const lapack_complex_double* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA) {
    pzher_(UPLO, &N, &ALPHA, X, &IX, &JX, DESCX, &INCX, A, &IA, &JA, DESCA);
}

void SCALAPACKE_pcherk(const char* UPLO, const char* TRANS, const lapack_int N, const lapack_int K, const float ALPHA, const lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const float BETA, lapack_complex_float* C, const lapack_int IC, const lapack_int JC, const lapack_int* DESCC) {
    pcherk_(UPLO, TRANS, &N, &K, &ALPHA, A, &IA, &JA, DESCA, &BETA, C, &IC, &JC, DESCC);
}

void SCALAPACKE_pzherk(const char* UPLO, const char* TRANS, const lapack_int N, const lapack_int K, const double ALPHA, const lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const double BETA, lapack_complex_double* C, const lapack_int IC, const lapack_int JC, const lapack_int* DESCC) {
...
void SCALAPACKE_pcscal(const lapack_int N, const lapack_complex_float ALPHA, lapack_complex_float* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX) {
...
void SCALAPACKE_pzscal(const lapack_int N, const lapack_complex_double ALPHA, lapack_complex_double* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX) {
    pzscal_(&N, &ALPHA, X, &IX, &JX, DESCX, &INCX);
}

void SCALAPACKE_pcsscal(const lapack_int N, const float ALPHA, lapack_complex_float* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX) {
    pcsscal_(&N, &ALPHA, X, &IX, &JX, DESCX, &INCX);
}

void SCALAPACKE_pcswap(const lapack_int N, lapack_complex_float* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, lapack_complex_float* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY) {
...
void SCALAPACKE_pzswap(const lapack_int N, lapack_complex_double* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX, lapack_complex_double* Y, const lapack_int IY, const lapack_int JY, const lapack_int* DESCY, const lapack_int INCY) {
    pzswap_(&N, X, &IX, &JX, DESCX, &INCX, Y, &IY, &JY, DESCY, &INCY);
}

void SCALAPACKE_pcsymm(const char* SIDE, const char* UPLO, const lapack_int M, const lapack_int N, const lapack_complex_float ALPHA, const lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_float* B, const lapack_int IB, const lapack_int JB, const lapack_int* DESCB, const lapack_complex_float BETA, lapack_complex_float* C, const lapack_int IC, const lapack_int JC, const lapack_int* DESCC) {
...
void SCALAPACKE_pzsymm(const char* SIDE, const char* UPLO, const lapack_int M, const lapack_int N, const lapack_complex_double ALPHA, const lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_double* B, const lapack_int IB, const lapack_int JB, const lapack_int* DESCB, const lapack_complex_double BETA, lapack_complex_double* C, const lapack_int IC, const lapack_int JC, const lapack_int* DESCC) {
...
void SCALAPACKE_pcsyr2k(const char* UPLO, const char* TRANS, const lapack_int N, const lapack_int K, const lapack_complex_float ALPHA, const lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_float* B, const lapack_int IB, const lapack_int JB, const lapack_int* DESCB, const lapack_complex_float BETA, lapack_complex_float* C, const lapack_int IC, const lapack_int JC, const lapack_int* DESCC) {
...
void SCALAPACKE_pzsyr2k(const char* UPLO, const char* TRANS, const lapack_int N, const lapack_int K, const lapack_complex_double ALPHA, const lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_double* B, const lapack_int IB, const lapack_int JB, const lapack_int* DESCB, const lapack_complex_double BETA, lapack_complex_double* C, const lapack_int IC, const lapack_int JC, const lapack_int* DESCC) {
...
void SCALAPACKE_pcsyrk(const char* UPLO, const char* TRANS, const lapack_int N, const lapack_int K, const lapack_complex_float ALPHA, const lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_float BETA, lapack_complex_float* C, const lapack_int IC, const lapack_int JC, const lapack_int* DESCC) {
...
void SCALAPACKE_pzsyrk(const char* UPLO, const char* TRANS, const lapack_int N, const lapack_int K, const lapack_complex_double ALPHA, const lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_double BETA, lapack_complex_double* C, const lapack_int IC, const lapack_int JC, const lapack_int* DESCC) {
    pzsyrk_(UPLO, TRANS, &N, &K, &ALPHA, A, &IA, &JA, DESCA, &BETA, C, &IC, &JC, DESCC);
}

void SCALAPACKE_pctradd(const char* UPLO, const char* TRANS, const lapack_int M, const lapack_int N, const lapack_complex_float ALPHA, const lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_float BETA, lapack_complex_float* C, const lapack_int IC, const lapack_int JC, const lapack_int* DESCC) {
...
void SCALAPACKE_pztradd(const char* UPLO, const char* TRANS, const lapack_int M, const lapack_int N, const lapack_complex_double ALPHA, const lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_double BETA, lapack_complex_double* C, const lapack_int IC, const lapack_int JC, const lapack_int* DESCC) {
...
void SCALAPACKE_pctranc(const lapack_int M, const lapack_int N, const lapack_complex_float ALPHA, const lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_float BETA, lapack_complex_float* C, const lapack_int IC, const lapack_int JC, const lapack_int* DESCC) {
    pctranc_(&M, &N, &ALPHA, A, &IA, &JA, DESCA, &BETA, C, &IC, &JC, DESCC);
}

void SCALAPACKE_pztranc(const lapack_int M, const lapack_int N, const lapack_complex_double ALPHA, const lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_double BETA, lapack_complex_double* C, const lapack_int IC, const lapack_int JC, const lapack_int* DESCC) {
    pztranc_(&M, &N, &ALPHA, A, &IA, &JA, DESCA, &BETA, C, &IC, &JC, DESCC);
}

void SCALAPACKE_pctranu(const lapack_int M, const lapack_int N, const lapack_complex_float ALPHA, const lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_float BETA, lapack_complex_float* C, const lapack_int IC, const lapack_int JC, const lapack_int* DESCC) {
    pctranu_(&M, &N, &ALPHA, A, &IA, &JA, DESCA, &BETA, C, &IC, &JC, DESCC);
}

void SCALAPACKE_pztranu(const lapack_int M, const lapack_int N, const lapack_complex_double ALPHA, const lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, const lapack_complex_double BETA, lapack_complex_double* C, const lapack_int IC, const lapack_int JC, const lapack_int* DESCC) {
    pztranu_(&M, &N, &ALPHA, A, &IA, &JA, DESCA, &BETA, C, &IC, &JC, DESCC);
}

void SCALAPACKE_pctrmm(const char* SIDE, const char* UPLO, const char* TRANS, const char* DIAG, const lapack_int M, const lapack_int N, const lapack_complex_float ALPHA, const lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, lapack_complex_float* B, const lapack_int IB, const lapack_int JB, const lapack_int* DESCB) {
...
void SCALAPACKE_pztrmm(const char* SIDE, const char* UPLO, const char* TRANS, const char* DIAG, const lapack_int M, const lapack_int N, const lapack_complex_double ALPHA, const lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, lapack_complex_double* B, const lapack_int IB, const lapack_int JB, const lapack_int* DESCB) {
    pztrmm_(SIDE, UPLO, TRANS, DIAG, &M, &N, &ALPHA, A, &IA, &JA, DESCA, B, &IB, &JB, DESCB);
}

void SCALAPACKE_pctrmv(const char* UPLO, const char* TRANS, const char* DIAG, const lapack_int N, const lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, lapack_complex_float* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX) {
...
void SCALAPACKE_pztrmv(const char* UPLO, const char* TRANS, const char* DIAG, const lapack_int N, const lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, lapack_complex_double* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX) {
    pztrmv_(UPLO, TRANS, DIAG, &N, A, &IA, &JA, DESCA, X, &IX, &JX, DESCX, &INCX);
}

void SCALAPACKE_pctrsm(const char* SIDE, const char* UPLO, const char* TRANS, const char* DIAG, const lapack_int M, const lapack_int N, const lapack_complex_float ALPHA, const lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, lapack_complex_float* B, const lapack_int IB, const lapack_int JB, const lapack_int* DESCB) {
...
void SCALAPACKE_pztrsm(const char* SIDE, const char* UPLO, const char* TRANS, const char* DIAG, const lapack_int M, const lapack_int N, const lapack_complex_double ALPHA, const lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, lapack_complex_double* B, const lapack_int IB, const lapack_int JB, const lapack_int* DESCB) {
    pztrsm_(SIDE, UPLO, TRANS, DIAG, &M, &N, &ALPHA, A, &IA, &JA, DESCA, B, &IB, &JB, DESCB);
}

void SCALAPACKE_pctrsv(const char* UPLO, const char* TRANS, const char* DIAG, const lapack_int N, const lapack_complex_float* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, lapack_complex_float* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX) {
...
void SCALAPACKE_pztrsv(const char* UPLO, const char* TRANS, const char* DIAG, const lapack_int N, const lapack_complex_double* A, const lapack_int IA, const lapack_int JA, const lapack_int* DESCA, lapack_complex_double* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX) {
    pztrsv_(UPLO, TRANS, DIAG, &N, A, &IA, &JA, DESCA, X, &IX, &JX, DESCX, &INCX);
}

void SCALAPACKE_pdzasum(const lapack_int N, double* ASUM, const lapack_complex_double* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX) {
    pdzasum_(&N, ASUM, X, &IX, &JX, DESCX, &INCX);
}

void SCALAPACKE_pdznrm2(const lapack_int N, double* NORM2, const lapack_complex_double* X, const lapack_int IX, const lapack_int JX, const lapack_int* DESCX, const lapack_int INCX) {
