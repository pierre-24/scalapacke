...
Lastest version: [v0.2.1](https://github.com/pierre-24/scalapacke/releases/tag/v0.2.1), corresponding to [scaLAPACK v2.2.0](https://github.com/Reference-ScaLAPACK/scalapack/releases/tag/v2.2.0).
